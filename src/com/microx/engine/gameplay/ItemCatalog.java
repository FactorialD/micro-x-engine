...
public final class ItemCatalog {
    ...
    public static final byte[] TYPE = {0, TYPE_WEAPON, TYPE_WEAPON, TYPE_ARMOR, TYPE_CONSUMABLE,
            TYPE_CONSUMABLE, TYPE_ARTIFACT, TYPE_ARTIFACT, TYPE_AMMO, TYPE_AMMO};
    ...
    public static boolean valid(int id) {
        return id > 0 && id <= MAX_ID && TYPE[id] != 0;
    }
}
