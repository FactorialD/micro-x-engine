...
public final class GameMIDlet extends MIDlet {
 ...
 protected void startApp(){if(engine==null){engine=new Engine();canvas=new GameCanvas3D(engine,"true".equals(getAppProperty("MicroX-Debug")));Display.getDisplay(this).setCurrent(canvas);if(!engine.start())notifyDestroyed();}else engine.resume();}
